...
INSERT INTO "new_ForumPost" ("ageRating", "authorId", "content", "coverUrl", "createdAt", "id", "isPinned", "mediaCount", "title", "updatedAt") SELECT "ageRating", "authorId", "content", "coverUrl", "createdAt", "id", "isPinned", "mediaCount", "title", "updatedAt" FROM "ForumPost";
